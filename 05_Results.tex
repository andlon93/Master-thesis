...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp1/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp1/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp1/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp1/Vocabulary1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp1/Genes1}}
...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/Vocabulary1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/Genes1}}
...
\begin{figure}[htbp]
    \centering
    \ContinuedFloat
    \subfigure[Social network at generation 5.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/_graph5}}
    \hfill
    \subfigure[Social network at generation 20.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/_graph20}}
    \subfigure[Social network at generation 40.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/_graph40}}
    \hfill
    \subfigure[Social network at generation 100.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/_graph100}}
    \label{fig:SN2}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp3/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp3/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp3/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp3/Vocabulary1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp3/Genes1}}
    \caption{blabla}
    \label{fig:Fitness3}
\end{figure}
\begin{figure}[htbp]
...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/Vocabulary1}}
    \par \bisgkip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/genes1}}
    \hfill
    \label{fig:Fitness4}
\end{figure}
\begin{figure}
    \ContinuedFloat
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/_graph5}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/_graph20}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/_graph40}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp4/_graph100}}
    \label{fig:SN4}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp5/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp5/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp5/UniqueWords1}}
    \hfill
...
\begin{figure}[htbp]
    \centering
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6/Degree1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6/Vocabulary1}}
    \par \bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6.1/UniqueWords1}}
    \caption{blabla}
    \label{fig:Fitness6}
\end{figure}
...
One other experiment was performed with the probability set to $0.45$. This graph shows how the number of unique words were affected by this change \ref{fig:Fitness7}. The other graphs have not been included because they will not be relevant to the discussion\todo{legg ved de andre grafene i appendix}. The number of unique words quickly dropped to about five, but from five it struggled to actually reach consensus. From generation $61$ to the end of the simulation, the number of unique highest ranked words varied from one to three.  
...
\begin{figure}[htbp]
    ...
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/Fitness1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/Degree1}}
    \par\bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/UniqueWords1}}
    \hfill
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/Vocabulary1}}
    \par\bigskip
    \subfigure[]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7.1/UniqueWords1}}
    \caption{blabla}
    \label{fig:Fitness7}
\end{figure}