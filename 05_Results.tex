...
\begin{figure}
    ...
    \par \bigskip
    \subfigure[Average vocabulary size.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp2/Vocabulary1}}
    \hfill
...
\begin{figure}[htbp]
    ...
    \hfill
    \subfigure[Green: Average vocabulary size. Blue: Successful dialogues divided by total number of dialogues.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp5/Vocabulary1}}
