...
\begin{figure}[htbp]
    \centering
    \subfigure[The average fitness.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp6/Vocabulary1}\label{fig:Fitness6}}
    \hfill
...
\begin{figure}
    ...
    \caption{Graphs from experiment 6: \subref{fig:succDia6} Successful dialogues divided by total number of dialogues; \subref{fig:Vocabulary6} Average vocabulary size; and \subref{fig:uniqueWords6} Number of unique highest ranked words in the population.}
    \label{fig:exp6.1}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \subfigure[The average fitness.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/Fitness1}\label{fig:Fitness7}}
    \hfill
    \subfigure[The average degree.]{\includegraphics[width=0.49\linewidth]{fig/Results/Exp7/Degree1}\label{fig:Degree7}}
