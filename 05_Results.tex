...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 1: \subref{fig:Fitness1} The average fitness; \subref{fig:Degree1} The average degree.}
    \label{fig:exp1.0}
\end{figure}
\begin{figure}
    \centering
...
\begin{figure}[htbp]
    ...
    \caption{Snapshots of the social network of experiment 1 at generation \subref{fig:exp1SN5} 5, \subref{fig:exp1SN20} 20, \subref{fig:exp1SN40} 40, and \subref{fig:exp1SN100} 100.}
    \label{fig:exp1.2}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 2: \subref{fig:Fitness2} The average fitness; \subref{fig:Degree2} The average degree.}
    \label{fig:exp2.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 2: \subref{fig:exp2Genes} Three graphs that show the evolution of the the traits in the genome. The green function represents the average probability of conducting parent-child dialogues, the blue function represents the average learning rate, and the red function represents the average probability of acting extrovertly; \subref{fig:uniqueWords2} The number of unique highest ranked words in the population; \subref{fig:Vocabulary2} The average vocabulary size; \subref{fig:succDia2} Successful dialogues divided by total number of dialogues.}
    \label{fig:exp2.1}
\end{figure}
\begin{figure}[htbp]
    \centering
    ...
    \caption{Snapshots of the social network of experiment 2 at generation \subref{fig:exp2SN5} 5, \subref{fig:exp2SN20} 20, \subref{fig:exp2SN40} 40, and \subref{fig:exp2SN100} 100.}
    \label{fig:exp2.2}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 3: \subref{fig:Fitness3} The average fitness; \subref{fig:Degree3} The average degree.}
    \label{fig:exp3.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 3: \subref{fig:exp3Genes} Three graphs that show the evolution of the the traits in the genome. The green function represents the average probability of conducting parent-child dialogues, the blue function represents the average learning rate, and the red function represents the average probability of acting extrovertly; \subref{fig:uniqueWords3} The number of unique highest ranked words in the population; \subref{fig:Vocabulary3} The average vocabulary size; \subref{fig:succDia3} Successful dialogues divided by total number of dialogues.}
    \label{fig:exp3.1}
\end{figure}
\begin{figure}[htbp]
    \centering
    ...
    \caption{Snapshots of the social network of experiment 3 at generation \subref{fig:exp3SN5} 5, \subref{fig:exp3SN10} 10, \subref{fig:exp3SN40} 40, and \subref{fig:exp3SN100} 100.}
    \label{fig:exp3.2}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 4: \subref{fig:Fitness4} The average fitness; \subref{fig:Degree4} The average degree.}
    \label{fig:exp4.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 4: \subref{fig:Genes4} Three graphs that show the evolution of the the traits in the genome. The green function represents the average probability of conducting parent-child dialogues, the blue function represents the average learning rate, and the red function represents the average probability of acting extrovertly; \subref{fig:uniqueWords4} The number of unique highest ranked words in the population; \subref{fig:Vocabulary4} The average vocabulary size; \subref{fig:succDia4} Successful dialogues divided by total number of dialogues.}
    \label{fig:exp4.1}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 5: \subref{fig:Fitness5} The average fitness; \subref{fig:Degree5} The average degree.}
    \label{fig:exp5.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 5: \subref{fig:Genes5} Three graphs that show the evolution of the the traits in the genome. The green function represents the average probability of conducting parent-child dialogues, the blue function represents the average learning rate, and the red function represents the average probability of acting extrovertly; \subref{fig:uniqueWords5} The number of unique highest ranked words in the population; \subref{fig:Vocabulary5} The average vocabulary size; \subref{fig:succDia5} Successful dialogues divided by total number of dialogues.}
    \label{fig:exp5.1}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 6: \subref{fig:Fitness6} The average fitness; \subref{fig:Degree6} The average degree.}
    \label{fig:exp6.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 6: \subref{fig:Vocabulary6} The average vocabulary size; \subref{fig:succDia6} Successful dialogues divided by total number of dialogues; \subref{fig:uniqueWords6} The number of unique highest ranked words in the population of experiment 6a and 6b.}
    \label{fig:exp6.1}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Results from experiment 7: \subref{fig:Fitness7} The average fitness; \subref{fig:Degree7} The average degree.}
    \label{fig:exp7.0}
\end{figure}
\begin{figure}
    \centering
    ...
    \caption{Results from experiment 7: \subref{fig:Genes7} Three graphs that show the evolution of the the traits in the genome. The green function represents the average probability of conducting parent-child dialogues, the blue function represents the average learning rate, and the red function represents the average probability of acting extrovertly; \subref{fig:Vocabulary7} The average vocabulary size; \subref{fig:succDia7} Successful dialogues divided by total number of dialogues; \subref{fig:uniqueWords7} The number of unique highest ranked words in the population of experiment 7a and 7b.}
    \label{fig:exp7.1}
\end{figure}
