...
Agents also alter their personality based on who they communicate with. After a conversation, both agents alter their values using the following formula \todo{new = old + rate*old}
