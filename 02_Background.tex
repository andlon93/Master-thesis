...
This chapter will present theories within the field of language evolution, graph theory, social network theory, personalities, and \acp{ga}.\todo{skriv hvorfor disse tingene tas opp i teorien også.}
\todo{Legg in Schwartz i teori kapittelet}.
...
\subsection{Spatial naming games}
...
\begin{figure}[htbp]
    \centering
    \subfigure[Directed graph.]{\includegraphics[width=0.35\linewidth, scale=0.7]{Directed_graph}}
    \qquad\qquad\qquad
    \subfigure[Undirected graph.]{\includegraphics[width=0.35\linewidth, scale=0.7]{Undirected_graph}\label{fig:undirectedGraph}}
